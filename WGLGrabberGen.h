...
extern void (*glTransformFeedbackBufferRange)(GLuint xfb, GLuint index, GLuint buffer, GLintptr offset, GLsizei size);
...
extern void (*glNamedBufferStorage)(GLuint buffer, GLsizei size, const void *data, GLbitfield flags);
extern void (*glNamedBufferData)(GLuint buffer, GLsizei size, const void *data, GLenum usage);
extern void (*glNamedBufferSubData)(GLuint buffer, GLintptr offset, GLsizei size, const void *data);
extern void (*glCopyNamedBufferSubData)(GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizei size);
extern void (*glClearNamedBufferData)(GLuint buffer, GLenum internalformat, GLenum format, GLenum type, const void *data);
extern void (*glClearNamedBufferSubData)(GLuint buffer, GLenum internalformat, GLintptr offset, GLsizei size, GLenum format, GLenum type, const void *data);
extern GLboolean (*glUnmapNamedBuffer)(GLuint buffer);
extern void (*glFlushMappedNamedBufferRange)(GLuint buffer, GLintptr offset, GLsizei length);
...
extern void (*glGetNamedBufferSubData)(GLuint buffer, GLintptr offset, GLsizei size, void *data);
...
extern void (*glTextureBufferRange)(GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizei size);
...
extern void (*glSampleCoverageOES)(GLfixed value, GLboolean invert);
...
extern void (*glTexturePageCommitmentEXT)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean resident);
